...
export class Article extends Component {
    ...
    static propTypes = {
        ...
        trackUserEvent: PropTypes.func.isRequired,
    ...
    componentWillUnmount() {
        if (this.props.isAuthenticated) {
            ...
            if (this.state.startTime) {
                ...
                // Envoyer elapsedTime au serveur
                console.log(`User spent ${elapsedTime} milliseconds on this article.`);
                this.props.trackUserEvent('article_view', { user: this.props.user, item: this.props.para, duration: elapsedTime }); // Utilisation de trackUserEvent
    
                // Ici, vous pouvez envoyer elapsedTime au serveur via une méthode appropriée
            }
        }
    }
                        ...
                        <div className="row">
                            <div className="col-md-12 col-lg-8">
                                ...
                                <div className="single-post">
                                    <div className="images-post carousel ">
...
export default connect(mapStateToProps, { getItem, getSimilarItemStatique, getSimilarItemIA, getItemsWithCategory, addReview, getReviewsItem, getStatisticReviews, trackUserEvent })(withRouter(Article));